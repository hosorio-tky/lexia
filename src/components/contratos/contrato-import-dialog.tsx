...
import { importarContratos } from "@/app/actions/importar-contratos";
import type { ImportResult } from "@/app/actions/importar-contratos";
...
export function ContratoImportDialog({ open, onClose, onSuccess }: Props) {
  ...
  async function handleImport() {
    ...
    try {
      const res = await importarContratos(fd);
      setResult(res);
      setStage("result");
    ...
    <Dialog open={open} onOpenChange={(v) => !v && handleClose()}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Descarga la plantilla, complétala y sube el archivo para importar contratos en lote.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex items-center justify-between rounded-xl border bg-muted/40 px-4 py-3">
          ...
          <a href="/api/contratos/plantilla" download>
