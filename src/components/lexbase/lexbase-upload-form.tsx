...
export function LexbaseUploadForm({ categorias }: LexbaseUploadFormProps) {
  ...
  const [tipo, setTipo]              = useState<string>("Ley");
  const [categoriaId, setCategoriaId] = useState<string>("");
  const [pais, setPais]              = useState<string>("El Salvador");
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Input id="titulo" name="titulo" required placeholder="Ej. Código de Trabajo" />
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Input id="fecha_publicacion" name="fecha_publicacion" type="date" />
          </div>

          {/* Fecha vigencia */}
          <div className="space-y-1.5">
            <Label htmlFor="fecha_vigencia">Fecha de vigencia</Label>
            <Input id="fecha_vigencia" name="fecha_vigencia" type="date" />
          </div>
          ...
          {/* Descripción reformas */}
          {tieneReformas && (
            <div className="space-y-1.5">
              <Label htmlFor="reformas_descripcion">Descripción de reformas</Label>
              <Textarea
                id="reformas_descripcion"
                name="reformas_descripcion"
            ...
            <>
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  PDF, DOCX, DOC o TXT — hasta 50 MB
                </p>
              </div>
            </>
          )}
